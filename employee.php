...
<body>
  ...
  <div class="container">
    <h3>Employee</h3>
    <a href="addEmployee.php"><button type="button" class="btn btn-default" style="margin-bottom:10px">Add Employee</button></a>
    <table class="table table-bordered table-striped table-hover" id="myTable">
      ...
      <?php
        ...
        for($x = 0; $x < $length; $x++){
          echo "<tr class='table-row' onclick='route(".$employees[$x]->getId().")'>";
          echo "<td>".($x+1)."</td>";
          echo "<td>".$employees[$x]->getId()."</td>";
          echo "<td>".$employees[$x]->getFirstName()."</td>";
          echo "<td>".$employees[$x]->getLastName()."</td>";
          echo "<td>".$employees[$x]->getType()."</td>";
          echo "</tr>"; 
        }
      ?>
      </tbody>
...
<script>
function route(id) {
  document.location = "editEmployee.php?id="+id;
}
</script>
</html>