...
<html lang="en">
<head>
  <title>ACME: Performance Report</title>
  <meta charset="utf-8">
...
<body>
  ...
  <div class="container col-sm-12">
    ...
    <form action ="performanceReportView.php" method="post" target="_blank">
      <div class ="col-sm-4">
        ...
        <div class="form-group">
          ...
          <select class="form-control" name="customer">
            <?php
                ...
                for($x = 0; $x < $length; $x++){
                  $name = $customers[$x]->getName();
                  echo "<option value=".$customers[$x]->getId().">".$name."</option>";
                }
            ?>
          </select>
        </div>
  ...
  <br>
    ...
    <div class ="container col-sm-12">
      ...
      <div class = "col-sm-1">
      <br>
        <button type="submit" class="btn btn-primary" name="submitPerformanceReport">Generate Report</button>
      </div>
    </div>
  </form>
