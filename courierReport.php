...
<html lang="en">
<head>
  <title>ACME: Courier Report</title>
  <meta charset="utf-8">
...
<body>
  ...
  <div class="container col-sm-12">
    ...
    <form action ="courierReportView.php" method="post" target="_blank">
      <div class ="col-sm-4">
  ...
  <br>
    ...
    <div class ="container col-sm-12">
      ...
      <div class = "col-sm-1">
      <br>
        <button type="submit" class="btn btn-primary" name="submitCourierReport">Generate Report</button>
      </div>
